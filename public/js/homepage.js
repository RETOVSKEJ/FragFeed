	...
	if (data.ok) {
		...
		result.forEach((elem, index) => {
			...
			const compiled =
				...
				<% } else { %>
				<% if(post.image) { %>
					<a class="post-img" href="/<%= post.id %>"><img onerror="this.onerror=null; this.src='/assets/nophoto.png'; this.alt = 'No Photo Available'"  id="img-preview" src="<%= post.image %>" alt="Post image" />
				<% } else { %>
